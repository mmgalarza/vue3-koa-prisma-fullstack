...
export const UsuariosFindFirstSelectSchema: z.ZodType<Prisma.UsuariosSelect> = z.object({
...
export const UsuariosFindFirstSelectZodSchema = z.object({
    idUsuario: z.boolean().optional(),
    username: z.boolean().optional(),
    email: z.boolean().optional(),
    password: z.boolean().optional(),
...
export const UsuariosFindFirstSchema: z.ZodType<Prisma.UsuariosFindFirstArgs> = z.object({ select: UsuariosFindFirstSelectSchema.optional(), include: z.lazy(() => UsuariosIncludeObjectSchema.optional()), orderBy: z.union([UsuariosOrderByWithRelationInputObjectSchema, UsuariosOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsuariosWhereInputObjectSchema.optional(), cursor: UsuariosWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsuariosScalarFieldEnumSchema, UsuariosScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsuariosFindFirstArgs>;

export const UsuariosFindFirstZodSchema = z.object({ select: UsuariosFindFirstSelectSchema.optional(), include: z.lazy(() => UsuariosIncludeObjectSchema.optional()), orderBy: z.union([UsuariosOrderByWithRelationInputObjectSchema, UsuariosOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsuariosWhereInputObjectSchema.optional(), cursor: UsuariosWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsuariosScalarFieldEnumSchema, UsuariosScalarFieldEnumSchema.array()]).optional() }).strict();