...
export const ProveedoresFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProveedoresSelect> = z.object({
...
export const ProveedoresFindFirstOrThrowSelectZodSchema = z.object({
    idProveedor: z.boolean().optional(),
    nombre: z.boolean().optional(),
    email: z.boolean().optional(),
    calle: z.boolean().optional(),
...
export const ProveedoresFindFirstOrThrowSchema: z.ZodType<Prisma.ProveedoresFindFirstOrThrowArgs> = z.object({ select: ProveedoresFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProveedoresIncludeObjectSchema.optional()), orderBy: z.union([ProveedoresOrderByWithRelationInputObjectSchema, ProveedoresOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProveedoresWhereInputObjectSchema.optional(), cursor: ProveedoresWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProveedoresScalarFieldEnumSchema, ProveedoresScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProveedoresFindFirstOrThrowArgs>;

export const ProveedoresFindFirstOrThrowZodSchema = z.object({ select: ProveedoresFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProveedoresIncludeObjectSchema.optional()), orderBy: z.union([ProveedoresOrderByWithRelationInputObjectSchema, ProveedoresOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProveedoresWhereInputObjectSchema.optional(), cursor: ProveedoresWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProveedoresScalarFieldEnumSchema, ProveedoresScalarFieldEnumSchema.array()]).optional() }).strict();