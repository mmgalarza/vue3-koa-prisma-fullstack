...
export const FacturaFindFirstOrThrowSelectSchema: z.ZodType<Prisma.FacturaSelect> = z.object({
...
export const FacturaFindFirstOrThrowSelectZodSchema = z.object({
    idVenta: z.boolean().optional(),
    cae: z.boolean().optional(),
    vencCae: z.boolean().optional(),
    neto: z.boolean().optional(),
...
export const FacturaFindFirstOrThrowSchema: z.ZodType<Prisma.FacturaFindFirstOrThrowArgs> = z.object({ select: FacturaFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => FacturaIncludeObjectSchema.optional()), orderBy: z.union([FacturaOrderByWithRelationInputObjectSchema, FacturaOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacturaWhereInputObjectSchema.optional(), cursor: FacturaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacturaScalarFieldEnumSchema, FacturaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FacturaFindFirstOrThrowArgs>;

export const FacturaFindFirstOrThrowZodSchema = z.object({ select: FacturaFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => FacturaIncludeObjectSchema.optional()), orderBy: z.union([FacturaOrderByWithRelationInputObjectSchema, FacturaOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacturaWhereInputObjectSchema.optional(), cursor: FacturaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacturaScalarFieldEnumSchema, FacturaScalarFieldEnumSchema.array()]).optional() }).strict();