...
export const TalonariosFindManySelectSchema: z.ZodType<Prisma.TalonariosSelect> = z.object({
...
export const TalonariosFindManySelectZodSchema = z.object({
    idTalon: z.boolean().optional(),
    nombre: z.boolean().optional(),
    inicio: z.boolean().optional(),
    fin: z.boolean().optional(),
