...
export const UsuarioEmpresaFindManySelectSchema: z.ZodType<Prisma.UsuarioEmpresaSelect> = z.object({
...
export const UsuarioEmpresaFindManySelectZodSchema = z.object({
    idUsuarioEmpresa: z.boolean().optional(),
    idUsuario: z.boolean().optional(),
    idEmpresa: z.boolean().optional(),
    usuario: z.boolean().optional(),
...
export const UsuarioEmpresaFindManySchema: z.ZodType<Prisma.UsuarioEmpresaFindManyArgs> = z.object({ select: UsuarioEmpresaFindManySelectSchema.optional(), include: z.lazy(() => UsuarioEmpresaIncludeObjectSchema.optional()), orderBy: z.union([UsuarioEmpresaOrderByWithRelationInputObjectSchema, UsuarioEmpresaOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsuarioEmpresaWhereInputObjectSchema.optional(), cursor: UsuarioEmpresaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsuarioEmpresaScalarFieldEnumSchema, UsuarioEmpresaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UsuarioEmpresaFindManyArgs>;

export const UsuarioEmpresaFindManyZodSchema = z.object({ select: UsuarioEmpresaFindManySelectSchema.optional(), include: z.lazy(() => UsuarioEmpresaIncludeObjectSchema.optional()), orderBy: z.union([UsuarioEmpresaOrderByWithRelationInputObjectSchema, UsuarioEmpresaOrderByWithRelationInputObjectSchema.array()]).optional(), where: UsuarioEmpresaWhereInputObjectSchema.optional(), cursor: UsuarioEmpresaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UsuarioEmpresaScalarFieldEnumSchema, UsuarioEmpresaScalarFieldEnumSchema.array()]).optional() }).strict();