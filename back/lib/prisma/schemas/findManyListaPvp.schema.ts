...
export const ListaPvpFindManySelectSchema: z.ZodType<Prisma.ListaPvpSelect> = z.object({
...
export const ListaPvpFindManySelectZodSchema = z.object({
    idListaPvp: z.boolean().optional(),
    nombre: z.boolean().optional(),
    criterio: z.boolean().optional(),
    fechaGen: z.boolean().optional(),
...
export const ListaPvpFindManySchema: z.ZodType<Prisma.ListaPvpFindManyArgs> = z.object({ select: ListaPvpFindManySelectSchema.optional(), include: z.lazy(() => ListaPvpIncludeObjectSchema.optional()), orderBy: z.union([ListaPvpOrderByWithRelationInputObjectSchema, ListaPvpOrderByWithRelationInputObjectSchema.array()]).optional(), where: ListaPvpWhereInputObjectSchema.optional(), cursor: ListaPvpWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ListaPvpScalarFieldEnumSchema, ListaPvpScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ListaPvpFindManyArgs>;

export const ListaPvpFindManyZodSchema = z.object({ select: ListaPvpFindManySelectSchema.optional(), include: z.lazy(() => ListaPvpIncludeObjectSchema.optional()), orderBy: z.union([ListaPvpOrderByWithRelationInputObjectSchema, ListaPvpOrderByWithRelationInputObjectSchema.array()]).optional(), where: ListaPvpWhereInputObjectSchema.optional(), cursor: ListaPvpWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ListaPvpScalarFieldEnumSchema, ListaPvpScalarFieldEnumSchema.array()]).optional() }).strict();