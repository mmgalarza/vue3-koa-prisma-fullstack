...
export const RegistroFindManySelectSchema: z.ZodType<Prisma.RegistroSelect> = z.object({
...
export const RegistroFindManySelectZodSchema = z.object({
    idRegistro: z.boolean().optional(),
    fecha: z.boolean().optional(),
    numero: z.boolean().optional(),
    idTipoDoc: z.boolean().optional(),
