...
export const RegistroFindFirstSelectSchema: z.ZodType<Prisma.RegistroSelect> = z.object({
...
export const RegistroFindFirstSelectZodSchema = z.object({
    idRegistro: z.boolean().optional(),
    fecha: z.boolean().optional(),
    numero: z.boolean().optional(),
    idTipoDoc: z.boolean().optional(),
