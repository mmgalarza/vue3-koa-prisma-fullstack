...
export const RegistroDetFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RegistroDetSelect> = z.object({
...
export const RegistroDetFindFirstOrThrowSelectZodSchema = z.object({
    idRegistroDet: z.boolean().optional(),
    idRegistro: z.boolean().optional(),
    idProducto: z.boolean().optional(),
    idAlmacen: z.boolean().optional(),
...
export const RegistroDetFindFirstOrThrowSchema: z.ZodType<Prisma.RegistroDetFindFirstOrThrowArgs> = z.object({ select: RegistroDetFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RegistroDetIncludeObjectSchema.optional()), orderBy: z.union([RegistroDetOrderByWithRelationInputObjectSchema, RegistroDetOrderByWithRelationInputObjectSchema.array()]).optional(), where: RegistroDetWhereInputObjectSchema.optional(), cursor: RegistroDetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RegistroDetScalarFieldEnumSchema, RegistroDetScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RegistroDetFindFirstOrThrowArgs>;

export const RegistroDetFindFirstOrThrowZodSchema = z.object({ select: RegistroDetFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RegistroDetIncludeObjectSchema.optional()), orderBy: z.union([RegistroDetOrderByWithRelationInputObjectSchema, RegistroDetOrderByWithRelationInputObjectSchema.array()]).optional(), where: RegistroDetWhereInputObjectSchema.optional(), cursor: RegistroDetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RegistroDetScalarFieldEnumSchema, RegistroDetScalarFieldEnumSchema.array()]).optional() }).strict();