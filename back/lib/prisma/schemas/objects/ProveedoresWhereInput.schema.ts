...
import { ListasListRelationFilterObjectSchema as ListasListRelationFilterObjectSchema } from './ListasListRelationFilter.schema'

const proveedoreswhereinputSchema = z.object({
  AND: z.union([z.lazy(() => ProveedoresWhereInputObjectSchema), z.lazy(() => ProveedoresWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => ProveedoresWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => ProveedoresWhereInputObjectSchema), z.lazy(() => ProveedoresWhereInputObjectSchema).array()]).optional(),
  ...
  listas: z.lazy(() => ListasListRelationFilterObjectSchema).optional()
}).strict();
export const ProveedoresWhereInputObjectSchema: z.ZodType<Prisma.ProveedoresWhereInput> = proveedoreswhereinputSchema as unknown as z.ZodType<Prisma.ProveedoresWhereInput>;
export const ProveedoresWhereInputObjectZodSchema = proveedoreswhereinputSchema;
