...
export const UsuariosCountOutputTypeCountUsuarioEmpresasArgsObjectSchema = makeSchema();
export const UsuariosCountOutputTypeCountUsuarioEmpresasArgsObjectZodSchema = makeSchema();
