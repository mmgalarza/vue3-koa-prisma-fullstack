...
export const ClientesMaxOrderByAggregateInputObjectSchema: z.ZodType<Prisma.ClientesMaxOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.ClientesMaxOrderByAggregateInput>;
export const ClientesMaxOrderByAggregateInputObjectZodSchema = makeSchema();
