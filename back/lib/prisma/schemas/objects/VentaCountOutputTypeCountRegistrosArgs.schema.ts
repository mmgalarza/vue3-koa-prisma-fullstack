...
export const VentaCountOutputTypeCountRegistrosArgsObjectSchema = makeSchema();
export const VentaCountOutputTypeCountRegistrosArgsObjectZodSchema = makeSchema();
