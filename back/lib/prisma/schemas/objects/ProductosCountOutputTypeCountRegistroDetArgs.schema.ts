...
export const ProductosCountOutputTypeCountRegistroDetArgsObjectSchema = makeSchema();
export const ProductosCountOutputTypeCountRegistroDetArgsObjectZodSchema = makeSchema();
