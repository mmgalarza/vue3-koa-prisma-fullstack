...
export const ListasCountOutputTypeCountDetallesArgsObjectSchema = makeSchema();
export const ListasCountOutputTypeCountDetallesArgsObjectZodSchema = makeSchema();
