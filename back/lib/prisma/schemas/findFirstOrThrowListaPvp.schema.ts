...
export const ListaPvpFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ListaPvpSelect> = z.object({
...
export const ListaPvpFindFirstOrThrowSelectZodSchema = z.object({
    idListaPvp: z.boolean().optional(),
    nombre: z.boolean().optional(),
    criterio: z.boolean().optional(),
    fechaGen: z.boolean().optional(),
...
export const ListaPvpFindFirstOrThrowSchema: z.ZodType<Prisma.ListaPvpFindFirstOrThrowArgs> = z.object({ select: ListaPvpFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ListaPvpIncludeObjectSchema.optional()), orderBy: z.union([ListaPvpOrderByWithRelationInputObjectSchema, ListaPvpOrderByWithRelationInputObjectSchema.array()]).optional(), where: ListaPvpWhereInputObjectSchema.optional(), cursor: ListaPvpWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ListaPvpScalarFieldEnumSchema, ListaPvpScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ListaPvpFindFirstOrThrowArgs>;

export const ListaPvpFindFirstOrThrowZodSchema = z.object({ select: ListaPvpFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ListaPvpIncludeObjectSchema.optional()), orderBy: z.union([ListaPvpOrderByWithRelationInputObjectSchema, ListaPvpOrderByWithRelationInputObjectSchema.array()]).optional(), where: ListaPvpWhereInputObjectSchema.optional(), cursor: ListaPvpWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ListaPvpScalarFieldEnumSchema, ListaPvpScalarFieldEnumSchema.array()]).optional() }).strict();