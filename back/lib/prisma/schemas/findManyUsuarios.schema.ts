...
export const UsuariosFindManySelectSchema: z.ZodType<Prisma.UsuariosSelect> = z.object({
...
export const UsuariosFindManySelectZodSchema = z.object({
    idUsuario: z.boolean().optional(),
    username: z.boolean().optional(),
    email: z.boolean().optional(),
    password: z.boolean().optional(),
