...
export const ListasFindFirstSelectSchema: z.ZodType<Prisma.ListasSelect> = z.object({
...
export const ListasFindFirstSelectZodSchema = z.object({
    idLista: z.boolean().optional(),
    idProveedor: z.boolean().optional(),
    refNo: z.boolean().optional(),
    fecha: z.boolean().optional(),
