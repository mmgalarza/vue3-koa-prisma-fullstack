...
export const FacturaFindFirstSelectSchema: z.ZodType<Prisma.FacturaSelect> = z.object({
...
export const FacturaFindFirstSelectZodSchema = z.object({
    idVenta: z.boolean().optional(),
    cae: z.boolean().optional(),
    vencCae: z.boolean().optional(),
    neto: z.boolean().optional(),
...
export const FacturaFindFirstSchema: z.ZodType<Prisma.FacturaFindFirstArgs> = z.object({ select: FacturaFindFirstSelectSchema.optional(), include: z.lazy(() => FacturaIncludeObjectSchema.optional()), orderBy: z.union([FacturaOrderByWithRelationInputObjectSchema, FacturaOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacturaWhereInputObjectSchema.optional(), cursor: FacturaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacturaScalarFieldEnumSchema, FacturaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FacturaFindFirstArgs>;

export const FacturaFindFirstZodSchema = z.object({ select: FacturaFindFirstSelectSchema.optional(), include: z.lazy(() => FacturaIncludeObjectSchema.optional()), orderBy: z.union([FacturaOrderByWithRelationInputObjectSchema, FacturaOrderByWithRelationInputObjectSchema.array()]).optional(), where: FacturaWhereInputObjectSchema.optional(), cursor: FacturaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FacturaScalarFieldEnumSchema, FacturaScalarFieldEnumSchema.array()]).optional() }).strict();