...
export const ActividadFindFirstSelectSchema: z.ZodType<Prisma.ActividadSelect> = z.object({
...
export const ActividadFindFirstSelectZodSchema = z.object({
    idActividad: z.boolean().optional(),
    idEmpresa: z.boolean().optional(),
    nombre: z.boolean().optional(),
    inicio: z.boolean().optional(),
...
export const ActividadFindFirstSchema: z.ZodType<Prisma.ActividadFindFirstArgs> = z.object({ select: ActividadFindFirstSelectSchema.optional(), include: z.lazy(() => ActividadIncludeObjectSchema.optional()), orderBy: z.union([ActividadOrderByWithRelationInputObjectSchema, ActividadOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActividadWhereInputObjectSchema.optional(), cursor: ActividadWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActividadScalarFieldEnumSchema, ActividadScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ActividadFindFirstArgs>;

export const ActividadFindFirstZodSchema = z.object({ select: ActividadFindFirstSelectSchema.optional(), include: z.lazy(() => ActividadIncludeObjectSchema.optional()), orderBy: z.union([ActividadOrderByWithRelationInputObjectSchema, ActividadOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActividadWhereInputObjectSchema.optional(), cursor: ActividadWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActividadScalarFieldEnumSchema, ActividadScalarFieldEnumSchema.array()]).optional() }).strict();