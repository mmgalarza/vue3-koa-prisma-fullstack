...
export const RegistroDetFindFirstSelectSchema: z.ZodType<Prisma.RegistroDetSelect> = z.object({
...
export const RegistroDetFindFirstSelectZodSchema = z.object({
    idRegistroDet: z.boolean().optional(),
    idRegistro: z.boolean().optional(),
    idProducto: z.boolean().optional(),
    idAlmacen: z.boolean().optional(),
...
export const RegistroDetFindFirstSchema: z.ZodType<Prisma.RegistroDetFindFirstArgs> = z.object({ select: RegistroDetFindFirstSelectSchema.optional(), include: z.lazy(() => RegistroDetIncludeObjectSchema.optional()), orderBy: z.union([RegistroDetOrderByWithRelationInputObjectSchema, RegistroDetOrderByWithRelationInputObjectSchema.array()]).optional(), where: RegistroDetWhereInputObjectSchema.optional(), cursor: RegistroDetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RegistroDetScalarFieldEnumSchema, RegistroDetScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RegistroDetFindFirstArgs>;

export const RegistroDetFindFirstZodSchema = z.object({ select: RegistroDetFindFirstSelectSchema.optional(), include: z.lazy(() => RegistroDetIncludeObjectSchema.optional()), orderBy: z.union([RegistroDetOrderByWithRelationInputObjectSchema, RegistroDetOrderByWithRelationInputObjectSchema.array()]).optional(), where: RegistroDetWhereInputObjectSchema.optional(), cursor: RegistroDetWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RegistroDetScalarFieldEnumSchema, RegistroDetScalarFieldEnumSchema.array()]).optional() }).strict();