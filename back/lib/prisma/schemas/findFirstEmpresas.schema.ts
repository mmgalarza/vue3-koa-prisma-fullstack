...
export const EmpresasFindFirstSelectSchema: z.ZodType<Prisma.EmpresasSelect> = z.object({
...
export const EmpresasFindFirstSelectZodSchema = z.object({
    idEmpresa: z.boolean().optional(),
    nombre: z.boolean().optional(),
    email: z.boolean().optional(),
    calle: z.boolean().optional(),
...
export const EmpresasFindFirstSchema: z.ZodType<Prisma.EmpresasFindFirstArgs> = z.object({ select: EmpresasFindFirstSelectSchema.optional(), include: z.lazy(() => EmpresasIncludeObjectSchema.optional()), orderBy: z.union([EmpresasOrderByWithRelationInputObjectSchema, EmpresasOrderByWithRelationInputObjectSchema.array()]).optional(), where: EmpresasWhereInputObjectSchema.optional(), cursor: EmpresasWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EmpresasScalarFieldEnumSchema, EmpresasScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EmpresasFindFirstArgs>;

export const EmpresasFindFirstZodSchema = z.object({ select: EmpresasFindFirstSelectSchema.optional(), include: z.lazy(() => EmpresasIncludeObjectSchema.optional()), orderBy: z.union([EmpresasOrderByWithRelationInputObjectSchema, EmpresasOrderByWithRelationInputObjectSchema.array()]).optional(), where: EmpresasWhereInputObjectSchema.optional(), cursor: EmpresasWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EmpresasScalarFieldEnumSchema, EmpresasScalarFieldEnumSchema.array()]).optional() }).strict();