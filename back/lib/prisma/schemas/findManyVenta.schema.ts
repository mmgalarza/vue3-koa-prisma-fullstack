...
export const VentaFindManySelectSchema: z.ZodType<Prisma.VentaSelect> = z.object({
...
export const VentaFindManySelectZodSchema = z.object({
    idVenta: z.boolean().optional(),
    fecha: z.boolean().optional(),
    estado: z.boolean().optional(),
    idEmpresa: z.boolean().optional(),
