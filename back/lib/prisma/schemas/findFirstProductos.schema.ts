...
export const ProductosFindFirstSelectSchema: z.ZodType<Prisma.ProductosSelect> = z.object({
...
export const ProductosFindFirstSelectZodSchema = z.object({
    idProducto: z.boolean().optional(),
    nombre: z.boolean().optional(),
    idCategoria: z.boolean().optional(),
    descripcion: z.boolean().optional(),
...
export const ProductosFindFirstSchema: z.ZodType<Prisma.ProductosFindFirstArgs> = z.object({ select: ProductosFindFirstSelectSchema.optional(), include: z.lazy(() => ProductosIncludeObjectSchema.optional()), orderBy: z.union([ProductosOrderByWithRelationInputObjectSchema, ProductosOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductosWhereInputObjectSchema.optional(), cursor: ProductosWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductosScalarFieldEnumSchema, ProductosScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductosFindFirstArgs>;

export const ProductosFindFirstZodSchema = z.object({ select: ProductosFindFirstSelectSchema.optional(), include: z.lazy(() => ProductosIncludeObjectSchema.optional()), orderBy: z.union([ProductosOrderByWithRelationInputObjectSchema, ProductosOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductosWhereInputObjectSchema.optional(), cursor: ProductosWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductosScalarFieldEnumSchema, ProductosScalarFieldEnumSchema.array()]).optional() }).strict();