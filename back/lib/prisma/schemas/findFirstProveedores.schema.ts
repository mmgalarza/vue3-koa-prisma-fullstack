...
export const ProveedoresFindFirstSelectSchema: z.ZodType<Prisma.ProveedoresSelect> = z.object({
...
export const ProveedoresFindFirstSelectZodSchema = z.object({
    idProveedor: z.boolean().optional(),
    nombre: z.boolean().optional(),
    email: z.boolean().optional(),
    calle: z.boolean().optional(),
