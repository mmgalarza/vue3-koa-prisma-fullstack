...
export const AlmacenesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AlmacenesSelect> = z.object({
...
export const AlmacenesFindFirstOrThrowSelectZodSchema = z.object({
    idAlmacen: z.boolean().optional(),
    nombre: z.boolean().optional(),
    interno: z.boolean().optional(),
    calle: z.boolean().optional(),
...
export const AlmacenesFindFirstOrThrowSchema: z.ZodType<Prisma.AlmacenesFindFirstOrThrowArgs> = z.object({ select: AlmacenesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AlmacenesIncludeObjectSchema.optional()), orderBy: z.union([AlmacenesOrderByWithRelationInputObjectSchema, AlmacenesOrderByWithRelationInputObjectSchema.array()]).optional(), where: AlmacenesWhereInputObjectSchema.optional(), cursor: AlmacenesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AlmacenesScalarFieldEnumSchema, AlmacenesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AlmacenesFindFirstOrThrowArgs>;

export const AlmacenesFindFirstOrThrowZodSchema = z.object({ select: AlmacenesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AlmacenesIncludeObjectSchema.optional()), orderBy: z.union([AlmacenesOrderByWithRelationInputObjectSchema, AlmacenesOrderByWithRelationInputObjectSchema.array()]).optional(), where: AlmacenesWhereInputObjectSchema.optional(), cursor: AlmacenesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AlmacenesScalarFieldEnumSchema, AlmacenesScalarFieldEnumSchema.array()]).optional() }).strict();