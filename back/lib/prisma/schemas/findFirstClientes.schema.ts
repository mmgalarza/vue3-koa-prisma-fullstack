...
export const ClientesFindFirstSelectSchema: z.ZodType<Prisma.ClientesSelect> = z.object({
...
export const ClientesFindFirstSelectZodSchema = z.object({
    idCliente: z.boolean().optional(),
    nombre: z.boolean().optional(),
    email: z.boolean().optional(),
    calle: z.boolean().optional(),
...
export const ClientesFindFirstSchema: z.ZodType<Prisma.ClientesFindFirstArgs> = z.object({ select: ClientesFindFirstSelectSchema.optional(), include: z.lazy(() => ClientesIncludeObjectSchema.optional()), orderBy: z.union([ClientesOrderByWithRelationInputObjectSchema, ClientesOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientesWhereInputObjectSchema.optional(), cursor: ClientesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientesScalarFieldEnumSchema, ClientesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClientesFindFirstArgs>;

export const ClientesFindFirstZodSchema = z.object({ select: ClientesFindFirstSelectSchema.optional(), include: z.lazy(() => ClientesIncludeObjectSchema.optional()), orderBy: z.union([ClientesOrderByWithRelationInputObjectSchema, ClientesOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientesWhereInputObjectSchema.optional(), cursor: ClientesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientesScalarFieldEnumSchema, ClientesScalarFieldEnumSchema.array()]).optional() }).strict();