...
export const ClientesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ClientesSelect> = z.object({
...
export const ClientesFindFirstOrThrowSelectZodSchema = z.object({
    idCliente: z.boolean().optional(),
    nombre: z.boolean().optional(),
    email: z.boolean().optional(),
    calle: z.boolean().optional(),
...
export const ClientesFindFirstOrThrowSchema: z.ZodType<Prisma.ClientesFindFirstOrThrowArgs> = z.object({ select: ClientesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ClientesIncludeObjectSchema.optional()), orderBy: z.union([ClientesOrderByWithRelationInputObjectSchema, ClientesOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientesWhereInputObjectSchema.optional(), cursor: ClientesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientesScalarFieldEnumSchema, ClientesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClientesFindFirstOrThrowArgs>;

export const ClientesFindFirstOrThrowZodSchema = z.object({ select: ClientesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ClientesIncludeObjectSchema.optional()), orderBy: z.union([ClientesOrderByWithRelationInputObjectSchema, ClientesOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientesWhereInputObjectSchema.optional(), cursor: ClientesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientesScalarFieldEnumSchema, ClientesScalarFieldEnumSchema.array()]).optional() }).strict();