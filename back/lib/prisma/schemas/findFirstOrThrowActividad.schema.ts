...
export const ActividadFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ActividadSelect> = z.object({
...
export const ActividadFindFirstOrThrowSelectZodSchema = z.object({
    idActividad: z.boolean().optional(),
    idEmpresa: z.boolean().optional(),
    nombre: z.boolean().optional(),
    inicio: z.boolean().optional(),
...
export const ActividadFindFirstOrThrowSchema: z.ZodType<Prisma.ActividadFindFirstOrThrowArgs> = z.object({ select: ActividadFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ActividadIncludeObjectSchema.optional()), orderBy: z.union([ActividadOrderByWithRelationInputObjectSchema, ActividadOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActividadWhereInputObjectSchema.optional(), cursor: ActividadWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActividadScalarFieldEnumSchema, ActividadScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ActividadFindFirstOrThrowArgs>;

export const ActividadFindFirstOrThrowZodSchema = z.object({ select: ActividadFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ActividadIncludeObjectSchema.optional()), orderBy: z.union([ActividadOrderByWithRelationInputObjectSchema, ActividadOrderByWithRelationInputObjectSchema.array()]).optional(), where: ActividadWhereInputObjectSchema.optional(), cursor: ActividadWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ActividadScalarFieldEnumSchema, ActividadScalarFieldEnumSchema.array()]).optional() }).strict();