...
export const ProductosFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductosSelect> = z.object({
...
export const ProductosFindFirstOrThrowSelectZodSchema = z.object({
    idProducto: z.boolean().optional(),
    nombre: z.boolean().optional(),
    idCategoria: z.boolean().optional(),
    descripcion: z.boolean().optional(),
...
export const ProductosFindFirstOrThrowSchema: z.ZodType<Prisma.ProductosFindFirstOrThrowArgs> = z.object({ select: ProductosFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductosIncludeObjectSchema.optional()), orderBy: z.union([ProductosOrderByWithRelationInputObjectSchema, ProductosOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductosWhereInputObjectSchema.optional(), cursor: ProductosWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductosScalarFieldEnumSchema, ProductosScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductosFindFirstOrThrowArgs>;

export const ProductosFindFirstOrThrowZodSchema = z.object({ select: ProductosFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductosIncludeObjectSchema.optional()), orderBy: z.union([ProductosOrderByWithRelationInputObjectSchema, ProductosOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductosWhereInputObjectSchema.optional(), cursor: ProductosWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductosScalarFieldEnumSchema, ProductosScalarFieldEnumSchema.array()]).optional() }).strict();