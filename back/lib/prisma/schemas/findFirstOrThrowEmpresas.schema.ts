...
export const EmpresasFindFirstOrThrowSelectSchema: z.ZodType<Prisma.EmpresasSelect> = z.object({
...
export const EmpresasFindFirstOrThrowSelectZodSchema = z.object({
    idEmpresa: z.boolean().optional(),
    nombre: z.boolean().optional(),
    email: z.boolean().optional(),
    calle: z.boolean().optional(),
...
export const EmpresasFindFirstOrThrowSchema: z.ZodType<Prisma.EmpresasFindFirstOrThrowArgs> = z.object({ select: EmpresasFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EmpresasIncludeObjectSchema.optional()), orderBy: z.union([EmpresasOrderByWithRelationInputObjectSchema, EmpresasOrderByWithRelationInputObjectSchema.array()]).optional(), where: EmpresasWhereInputObjectSchema.optional(), cursor: EmpresasWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EmpresasScalarFieldEnumSchema, EmpresasScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EmpresasFindFirstOrThrowArgs>;

export const EmpresasFindFirstOrThrowZodSchema = z.object({ select: EmpresasFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EmpresasIncludeObjectSchema.optional()), orderBy: z.union([EmpresasOrderByWithRelationInputObjectSchema, EmpresasOrderByWithRelationInputObjectSchema.array()]).optional(), where: EmpresasWhereInputObjectSchema.optional(), cursor: EmpresasWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EmpresasScalarFieldEnumSchema, EmpresasScalarFieldEnumSchema.array()]).optional() }).strict();