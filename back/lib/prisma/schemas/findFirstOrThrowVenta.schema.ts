...
export const VentaFindFirstOrThrowSelectSchema: z.ZodType<Prisma.VentaSelect> = z.object({
...
export const VentaFindFirstOrThrowSelectZodSchema = z.object({
    idVenta: z.boolean().optional(),
    fecha: z.boolean().optional(),
    estado: z.boolean().optional(),
    idEmpresa: z.boolean().optional(),
...
export const VentaFindFirstOrThrowSchema: z.ZodType<Prisma.VentaFindFirstOrThrowArgs> = z.object({ select: VentaFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => VentaIncludeObjectSchema.optional()), orderBy: z.union([VentaOrderByWithRelationInputObjectSchema, VentaOrderByWithRelationInputObjectSchema.array()]).optional(), where: VentaWhereInputObjectSchema.optional(), cursor: VentaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VentaScalarFieldEnumSchema, VentaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VentaFindFirstOrThrowArgs>;

export const VentaFindFirstOrThrowZodSchema = z.object({ select: VentaFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => VentaIncludeObjectSchema.optional()), orderBy: z.union([VentaOrderByWithRelationInputObjectSchema, VentaOrderByWithRelationInputObjectSchema.array()]).optional(), where: VentaWhereInputObjectSchema.optional(), cursor: VentaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VentaScalarFieldEnumSchema, VentaScalarFieldEnumSchema.array()]).optional() }).strict();